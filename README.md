...
## Project Structure
    ...
    ├── test_drive_valet_31182  # Django project configurations
...
1. Clone this repo and `cd test_drive_valet_31182`
...
2. Clone this repo and `cd test_drive_valet_31182`
